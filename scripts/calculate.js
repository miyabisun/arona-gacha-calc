...
function renderFaq(result, comparison, locale = 'ja') {
  ...
  return replaceExact(japanese, [
    ...
    ['グラフの読み方と、呼出ポイント・呼出チャージの計算方法です。', 'How to read the chart and how Recruitment Points and Recruitment Charge are calculated.'],
